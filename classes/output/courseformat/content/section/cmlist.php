...
namespace format_edukav\output\courseformat\content\section;
 ...
 * 
 * Modification for format_edukav:
...
class cmlist extends cmlist_base {
    ...
    public function export_for_template(\renderer_base $output): stdClass {
        ...
        if ($this->format->get_format_option('subsectionsascards') == FORMAT_EDUKAV_SUBSECTIONS_AS_ACTIVITIES) {
            return parent::export_for_template($output);
        }
